...
public class ElementalApplicatorItem extends Item {
    ...
    public ElementalApplicatorItem(Supplier<IElementalAura> applicationType, String applicatorId, Properties p_41383_) {
        ...
        this.applicationInstance = (applicationSource) -> new ApplicationInstance(this.getApplicationType(), 16f, 0f, applicationSource);
    ...
    public InteractionResult interactLivingEntity(ItemStack stack, Player player, LivingEntity entity, InteractionHand hand) {
        ...
        if (capability != null) {
            ...
            player.getLevel().playLocalSound(player.getOnPos(), SoundEvents.ENDER_DRAGON_FLAP, SoundSource.PLAYERS, 0.5f, 0.5f, false);
